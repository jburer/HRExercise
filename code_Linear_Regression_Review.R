# This code accompanies the Linear Regression Review topic and is
# maintained by Sam Burer. Last updated 2019-01-16

# To do:
#
# - Incorporate predictions
# - Add function to change base case
# - Switch from aa_critique_fit to aa_critique_lm
...
aa_critique_fit <- function(fit) {
    ...
    res$coefficients <- coefficients(fit)
