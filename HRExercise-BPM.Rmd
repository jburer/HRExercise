...
+ DistanceInFeet #+ DistanceInFeetPerMin   
#+ ElevationChangeInFeet #+ ElevationChangeInFeetPerMin  
+ Temp + DewPoint #+ Humidity
+ Exercise
+ IsSouthernSoul + IsWholeEnchilada + IsRiverwalk + IsHawksRidge  + IsStringers  + IsWhiteOakGreen
#+ Course
#+ Zone
#+ MaxBPM
#+ IsLessThan36HoursSinceLastAnything 
#+ IsLessThan48HoursSinceLastRunning #+ IsLessThan72HoursSinceLastRunning 
#+ IsLessThan48HoursSinceLastBiking #+ IsLessThan72HoursSinceLastBiking
...
+ temp + dewpoint
#+ exercise
+ isbiking +iswalking + isrunning #+ isyoga
#+ course
+ southernsoul + wholeenchilada + riverwalk + hawksridge + stringers + whiteoak
