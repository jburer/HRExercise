...
BPM <- ts(data = BPM, start = c(as.Date(HRExercise$DateTime[1])), end=c(as.Date(HRExercise$DateTime[113])), frequency = 1)

CaloriesPerMin <- data.frame(HRExercise$CaloriesPerMin)
CaloriesPerMin <- ts(data = CaloriesPerMin, start = c(as.Date(HRExercise$DateTime[1])), end=c(as.Date(HRExercise$DateTime[113])), frequency = 1)
